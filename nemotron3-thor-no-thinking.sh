...
#
# Thinking mode:
#   Nemotron 3 Nano generates an internal reasoning trace before responding.
#   This improves accuracy on hard tasks but adds latency on simple ones.
#   By default this script disables thinking for faster responses.
#   To enable thinking, remove the --default-chat-template-kwargs flag.
#
# Model name:
